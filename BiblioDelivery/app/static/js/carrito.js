...
const pintarCards = data => {
    data.forEach(producto =>{
        ...
        templateCard.querySelector('p').textContent= producto.precioProducto
        templateCard.querySelector('img').setAttribute("src",producto.imagenProducto)
        templateCard.querySelector('.btn-success').dataset.id=producto.codigoProducto
